...
class LSHIndex(VectorIndex):
    ...
    async def add(self, vector_id: UUID, vector: np.ndarray) -> None:
        ...
        async with self._lock.write():
            ...
            logger.debug(f"Added vector to LSH index", vector_id=str(vector_id))
    ...
    async def remove(self, vector_id: UUID) -> bool:
        ...
        async with self._lock.write():
            ...
            logger.debug(f"Removed vector from LSH index", vector_id=str(vector_id))
            return True
